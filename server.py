...
def add_history(filename, action):
    if filename not in history:
        history[filename] = []
    history[filename].append(action)
        ...
        while True:
            ...
            try:
                ...
                if command == 'login':
                    ...
                    add_history(filename, f"created by {current_user}")
                    ...
                    add_history(filename, f"uploaded by {current_user}")
                    ...
                    if os.path.exists(old_path):
                        ...
                        add_history(new_name, f"renamed from {old_name} by {current_user}")
                    ...
                    if os.path.exists(filepath):
                        with open(filepath, 'w') as f:
                            f.write(content)
                        add_history(filename, f"edited by {current_user}")
                    ...
                    if filename in history:
                        response = {'status': 'success', 'history': history[filename]}
                    else:
